...
describe('CONTEXT', () => {
  it('exerciseA', () => {
    const e = globalWindowObject === context.exerciseA();
    expect(e).withMessage('Your result is not the correct context').to.be.true;
  });
  
  it('exerciseB', () => {
    const e = globalWindowObject === context.exerciseB();
    expect(e).withMessage('Your result is not the correct context').to.be.true;
  });
  ...
  it('exerciseD', () => {
    const e = globalWindowObject === context.exerciseD();
    expect(e).withMessage('Your result is not the correct context').to.be.true;
  });
  
  it('exerciseE', () => {
    const e = globalWindowObject === context.exerciseE();
    expect(e).withMessage('Your result is not the correct context').to.be.true;
  });
  ...
  it('exerciseG', () => {
    const e = globalWindowObject === context.exerciseG();
    expect(e).withMessage('Your result is not the correct context').to.be.true;
  });
  ...
  it('exerciseO', () => {
    const e = globalWindowObject === context.exerciseO();
    expect(e).withMessage('Your result is not the correct context').to.be.true;
  });
  
  it('exerciseP', () => {
    const e = globalWindowObject === context.exerciseP();
    expect(e).withMessage('Your result is not the correct context').to.be.true;
  });
});